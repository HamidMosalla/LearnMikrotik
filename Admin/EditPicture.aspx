<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EditPicture.aspx.cs" Inherits="Admin_EditPicture" %>
...
<HeaderStyle Width="100px"></HeaderStyle>
            ...
            <asp:TemplateField HeaderText="&#1578;&#1608;&#1590;&#1740;&#1581;&#1575;&#1578; &#1593;&#1705;&#1587;" SortExpression="ArticleSummary">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox4" Width="500" Height="200" TextMode="MultiLine" runat="server" Text='<%# Bind("PictureDES") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("PictureDES") %>'></asp:TextBox>
                </InsertItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("PictureDES") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT Post.PostID, Post.PostTitle, Post.PostDate, Post.PostPicture, Picture.PostIDfk, Picture.PictureDES FROM Post INNER JOIN Picture ON Post.PostID = Picture.PostIDfk"
        UpdateCommand="Update_Post_Picture" UpdateCommandType="StoredProcedure"
         ...
         <asp:Parameter Name="PostDate" Type="String" />
          <asp:Parameter Name="PostPicture" Type="String" />
           <asp:Parameter Name="PostIDfk" Type="Int32" />
            <asp:Parameter Name="PictureDES" Type="String" />
    </UpdateParameters>
