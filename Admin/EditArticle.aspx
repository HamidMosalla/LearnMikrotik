<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EditArticle.aspx.cs" Inherits="Admin_EditArticle" %>
...
<HeaderStyle Width="100px"></HeaderStyle>
            ...
            <asp:TemplateField HeaderText="&#1593;&#1606;&#1608;&#1575;&#1606; &#1605;&#1602;&#1575;&#1604;&#1607;" SortExpression="PostTitle">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="&#1578;&#1575;&#1585;&#1740;&#1582; &#1605;&#1602;&#1575;&#1604;&#1607;" SortExpression="PostDate">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="&#1593;&#1705;&#1587; &#1605;&#1602;&#1575;&#1604;&#1607;" SortExpression="PostPicture">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="&#1582;&#1604;&#1575;&#1589;&#1607; &#1740; &#1605;&#1602;&#1575;&#1604;&#1607;" SortExpression="ArticleSummary">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox4" Width="500" Height="200" TextMode="MultiLine" runat="server" Text='<%# Bind("ArticleSummary") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("ArticleSummary") %>'></asp:TextBox>
                </InsertItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("ArticleSummary") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="&#1605;&#1581;&#1578;&#1608;&#1575;&#1740; &#1605;&#1602;&#1575;&#1604;&#1607;" SortExpression="ArticleContent">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox5" Width="500" Height="400" TextMode="MultiLine" runat="server" Text='<%# Bind("ArticleContent") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("ArticleContent") %>'></asp:TextBox>
                </InsertItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("ArticleContent") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:CheckBoxField DataField="ArticleVisible" HeaderText="&#1578;&#1575;&#1740;&#1740;&#1583; &#1605;&#1602;&#1575;&#1604;&#1607;" 
                SortExpression="ArticleVisible" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT Post.PostID, Post.PostTitle, Post.PostDate, Post.PostPicture, Article.PostIDfk, Article.ArticleSummary, Article.ArticleContent, Article.ArticleVisible FROM Post INNER JOIN Article ON Post.PostID = Article.PostIDfk"
        UpdateCommand="Update_Post_Article" UpdateCommandType="StoredProcedure"
         ...
         <asp:Parameter Name="PostDate" Type="String" />
          <asp:Parameter Name="PostPicture" Type="String" />
           <asp:Parameter Name="PostIDfk" Type="Int32" />
            <asp:Parameter Name="ArticleSummary" Type="String" />
             <asp:Parameter Name="ArticleContent" Type="String" />
       <asp:Parameter Name="ArticleVisible" Type="Boolean" />
    </UpdateParameters>
