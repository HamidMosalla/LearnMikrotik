<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EditVideo.aspx.cs" Inherits="Admin_EditVideo" %>
...
<HeaderStyle Width="100px"></HeaderStyle>
            ...
            <asp:TemplateField HeaderText="مسیر ویدئو" SortExpression="ArticleSummary">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox4" Width="500" Height="200" TextMode="MultiLine" runat="server" Text='<%# Bind("VideoUrl") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("VideoUrl") %>'></asp:TextBox>
                </InsertItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("VideoUrl") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="توضیحات ویدئو" SortExpression="ArticleContent">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox5" Width="500" Height="400" TextMode="MultiLine" runat="server" Text='<%# Bind("VideoDES") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("VideoDES") %>'></asp:TextBox>
                </InsertItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("VideoDES") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT Post.PostID, Post.PostTitle, Post.PostDate, Post.PostPicture, Video.PostIDfk, Video.VideoUrl, Video.VideoDES FROM Video INNER JOIN Post ON Video.PostIDfk = Post.PostID"
        UpdateCommand="Update_Post_Video" UpdateCommandType="StoredProcedure"
