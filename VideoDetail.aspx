<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VideoDetail.aspx.cs" Inherits="VideoDetail" %>
...
<h2 style=" font-size:large; border-bottom:2px solid #CCC" id="VideoDetailHeader" runat="server"></h2>
<br />
<p id="VideoDetailDate" style="color:#73A" runat="server"></p> 
<p id="VideoDetailSummary" style="color:Silver" runat="server"></p>
<hr />
   <video  width="600" height="400" id="VideoPlayer" runat="server"  controls="controls" >
    ...
    <object id="MediaPlayer" width="600"  height="400" classid="CLSID:22D6f312-B0F6-11D0-94AB-0080C74C7E95"
       ...
       <param name="filename" value="<%= this.InputValue %>"/>
      ...
      <img id="NoVideoCapable" runat="server" alt="امکان نمایش ویدئو را ندارید."  width="600" height="400" title="مرورگر شما امکان نمایش ویدئو را ندارد لطفا ویدئو را از لینک زیر دانلود کنید." />
     </object>
     </video>
     <br />
     <br />
     <p><a href="<%= this.InputValue %>"> دانلود این ویدئو</a></p>
...
<hr />
    ...
    EmptyStarCssClass="emptyRatingStar" onchanged="VideoRating_Changed" onload="VideoRating_Load" /> 
    ...
    <asp:ListView ID="CommentList" runat="server"  
            DataSourceID="VideoCommentsDataSource" DataKeyNames="CommentID" 
    ...
    <asp:SqlDataSource ID="VideoCommentsDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:LearnMikrotikConnectionString %>" 
