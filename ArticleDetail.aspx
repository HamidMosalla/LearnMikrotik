...
<h2 style=" font-size:large; border-bottom:2px solid #CCC" id="ArticleDetailHeader" runat="server"></h2>
<br />
<p id="ArticleDetailDate" style="color:#73A" runat="server"></p> 
<asp:HyperLink ID="ArticleAuthor" runat="server"></asp:HyperLink>
    <span style="color: #6600FF"><strong> :&#1606;&#1608;&#1588;&#1578;&#1607; &#1588;&#1583;&#1607; &#1578;&#1608;&#1587;&#1591;</strong></span>
        
<br />
<p id="ArticleDetailSummary" style="color:Silver" runat="server"></p>
<hr />
<br />
<br />
<asp:Image Width="640px" Height="400px" ID="ArticleDetailPicture" runat="server" />
<br />
<br />

    <div id="ArticleDetailContent" runat="server">
...
<hr />
    ...
    <ajaxToolkit:Rating ID="ArticleRating" runat="server"
    CurrentRating="0"
    MaxRating="10"
    StarCssClass="ratingStar"
    WaitingStarCssClass="savedRatingStar"
    FilledStarCssClass="filledRatingStar"
    EmptyStarCssClass="emptyRatingStar" onchanged="ArticleRating_Changed" onload="ArticleRating_Load" /> 
    ...
    <asp:ListView ID="CommentList" runat="server"  
            DataSourceID="ArticleCommentsDataSource" DataKeyNames="CommentID" 
    ...
    <asp:SqlDataSource ID="ArticleCommentsDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:LearnMikrotikConnectionString %>" 
