<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Miscellaneous.aspx.cs" Inherits="Miscellaneous" %>
...
<asp:ListView ID="ListView1" runat="server" DataKeyNames="PostID" DataSourceID="SqlDataSource1">
        ...
        <ItemTemplate>
            <span style="">
                <asp:HyperLink ID="MiscellaneousTitleLink" Text='<%# Eval("PostTitle") %>' NavigateUrl='<%# "MiscellaneousDetail.aspx?PostID=" + Eval("PostID") + "&PostTitle=" + Server.UrlEncode(Eval("PostTitle").ToString())%>'  runat="server"></asp:HyperLink>
            <br />
            <asp:Image ID="MiscellaneousImage" Width="70" Height="70" ImageUrl='<%# Eval("[PostPicture]") %>' runat="server" />
            <br />
            <asp:Label ID="MiscellaneousDate" runat="server" Text='<%# Eval("PostDate") %>' ForeColor="Gray" />
            <br />
            <asp:Label ID="MiscellaneousSummary" runat="server" Text='<%# Eval("MsSummary") %>' />
                <br />
                <br />
            </span>
        </ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT Post.PostID, Post.PostType, Post.PostTitle, Post.PostDate, Post.PostPicture, Miscellaneous.PostIDfk, Miscellaneous.MsSummary, Miscellaneous.MsContent FROM Post INNER JOIN Miscellaneous ON Post.PostID = Miscellaneous.PostIDfk ORDER BY Post.PostID DESC">
    </asp:SqlDataSource>
